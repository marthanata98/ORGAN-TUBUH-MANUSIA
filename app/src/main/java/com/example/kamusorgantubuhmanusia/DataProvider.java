package com.example.kamusorgantubuhmanusia;
...
import com.example.kamusorgantubuhmanusia.Organ;
import com.example.kamusorgantubuhmanusia.Pencernaan;
import com.example.kamusorgantubuhmanusia.PeredaranDarah;
import com.example.kamusorgantubuhmanusia.Pernapasan;
...
public class DataProvider {
    ...
    private static List<Pernapasan> initDataPernapasan(Context ctx) {
        List<Pernapasan> pernapasans = new ArrayList<>();
